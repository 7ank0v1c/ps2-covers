...
- Use this URL for default covers
  ```python
  https://raw.githubusercontent.com/7ank0v1c/ps2-covers/main/covers/default/${serial}.jpg
- or use this one for 3D covers.
  ```python
  https://raw.githubusercontent.com/7ank0v1c/ps2-covers/main/covers/3d/${serial}.png
